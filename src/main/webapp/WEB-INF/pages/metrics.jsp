...
<div class="span10">
    ...
    <display:table name="simpleMetrics" class="table table-condensed table-striped table-hover" requestURI="" id="simpleMetricsList" export="false" pagesize="25">
        <display:column property="id" sortable="true" href="simplemetricform" media="html"
            paramId="id" paramProperty="id" titleKey="metric.id"/>
        <display:column style="width:62px;" property="id" media="csv excel xml pdf" titleKey="metric.id"/>
        ...
        <display:setProperty name="paging.banner.items_name"><fmt:message key="simpleMetricsList.metrics"/></display:setProperty>
    ...
    <display:table name="combinedMetrics" class="table table-condensed table-striped table-hover" requestURI="" id="combinedMetricsList" export="false" pagesize="25">
        ...
        <display:setProperty name="paging.banner.items_name"><fmt:message key="combinedMetricsList.metrics"/></display:setProperty>
        <display:setProperty name="export.excel.filename"><fmt:message key="metricList.title"/>.xls</display:setProperty>
        <display:setProperty name="export.csv.filename"><fmt:message key="metricList.title"/>.csv</display:setProperty>
        <display:setProperty name="export.pdf.filename"><fmt:message key="metricList.title"/>.pdf</display:setProperty>
    </display:table>
