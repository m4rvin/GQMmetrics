...
<div class="span10">
	...
	<display:table name="measurementScaleList"
		...
		<display:column property="id" sortable="true"
			href="measurementScaleform" media="html" paramId="id"
			paramProperty="id" titleKey="measurementScale.id" />
		<display:column property="id" media="csv excel xml pdf"
			titleKey="measurementScale.id" />

		<display:column property="name" sortable="true"
			titleKey="measurementScale.name" />
		<display:column property="rangeOfValues" sortable="true"
			titleKey="measurementScale.rangeOfValues" />
		<display:column property="operations" sortable="true"
			titleKey="measurementScale.operations" />
